...
- Title "proposed_[name of doc]", Include quick info header, stating the doc was generated by AI, it's status (pending or approved), where it will go when approved. Include the purpose of the doc.

Example: 

**Status:** AI-generated | Approved for v0.1 to `01_core_constraints/`. Will need a review on what can be reduced/simplfied later.

**Purpose:** [purpose of the doc]